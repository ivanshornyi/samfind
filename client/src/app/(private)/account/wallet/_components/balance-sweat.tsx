...
export const BalanceSweat = ({ balance }: BalanceInfoProps) => {
  return (
    <div className="flex flex-col justify-between items-start rounded-2xl bg-[#242424] relative w-full p-8">
      <div className="w-full">
        ...
        <p className="text-[20px] leading-[27px] font-semibold">Sweat equity</p>
        <p className="text-[16px] leading-[22px] mt-2 md:mt-8">Total balance</p>
        ...
        <div className="flex flex-col xl:flex-row gap-2 w-full mt-4 md:mt-8">
          <div className="flex-1 w-full">
            <ConvertToBonusModal from={"Sweat equity"} />
          </div>
        </div>
      </div>
    </div>
