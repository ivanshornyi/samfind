...
export function InvestFAQ({ }: Props): React.ReactNode {
  return (
    <section aria-label="investment-hero" className="pt-[100px]">
      <div aria-label="wrapper" className="mx-auto flex gap-[50px] w-full max-w-[1440px] px-[140px]">
        <div className="w-[50%] flex flex-col gap-[25px]">
          <h2 className="text-white text-[48px] font-[600]">Invest Early. Gain More.</h2>
          <p className="text-white text-[16px] font-[600]">Join as an Early Bird investor and unlock exclusive benefits, or contact us if you're a major investor</p>
        </div>
