...
export const Support = () => {
  ...
  return (
    <div className="">
      <div className="bg-[#28282C] max-w-[1440px] bg-opacity-70 backdrop-blur-xs flex flex-col items-center justify-center ml-auto mr-auto font-manrope gap-[40px] min-w-[361px] h-[670px] rounded-[20px] ">
        <p className="text-[#CE9DF3] text-[16px] bg-[#242424] w-[113px] h-[34px] flex justify-center rounded-xl">
          Support
        </p>
        <p className="flex text-[48px] font-[600] text-center justify-center">
          Need help with <br className="sm:hidden" />
          something?
        </p>
        <p className="text-center sm:text-[20px] text-[16px] max-w-[490px] font-[600]">
          Our AI-powered chatbot is here 24/7 to <br className="sm:hidden" />
          answer all your questions.
        </p>
        <div>
          <Button
            className="bg-[#363637] backdrop-blur-[28.2px] text-white text-[16px] w-[192px] h-[44px] border-[1px] rounded-[30px]"
            onClick={() => context.toggleChat(true)}
          >
            Just chat with us
          </Button>
        </div>
