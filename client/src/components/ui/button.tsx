...
const buttonVariants = cva(
  "inline-flex z-100 cursor-pointer items-center justify-center border-[1px] gap-2 whitespace-nowrap rounded-full font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "border-primary-foreground bg-primary text-primary-foreground hover:text-primary active:shadow-[0_2px_20px_0_#B668F080] hover:bg-primary/90 hover:bg-gradient-to-r from-[#713FA5] to-[#26123A] disabled:text-disabled disabled:border-disabled",
        destructive:
